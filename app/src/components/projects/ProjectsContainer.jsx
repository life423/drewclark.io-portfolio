...
const PROJECTS = [
  {
    ...
    initialDescription: 'This project began as a challenge: how to visualize thousands of data points in real-time without sacrificing performance. I architected a solution using WebSockets for data streaming and custom D3.js visualizations that could handle high-frequency updates.'
  },
  {
    id: 2,
    ...
    initialDescription: 'As lead developer on this project, I implemented a natural language processing pipeline that could analyze existing content and generate new variations optimized for different target demographics. The system learned from user feedback to continuously improve output quality.'
  },
  {
    id: 3,
    ...
    initialDescription: 'Developing a cross-platform app that maintains native performance while sharing the majority of code was our primary objective. I designed a modular architecture that allowed platform-specific optimizations where needed while maintaining a consistent user experience.'
  }
];
          ...
          <div className="my-8 overflow-hidden rounded-xl shadow-lg bg-brandGray-800 border border-brandGray-700 transform transition-all duration-300 hover:shadow-xl hover:border-brandGray-600 shadow-[0_0_20px_-5px_rgba(16,185,129,0.15)]">
            ...
            <div className="p-8">
              <div className="prose prose-lg prose-invert max-w-none mb-6">
                <p>Welcome to an interactive journey through my portfolio projects. Rather than a simple list, I've created an experience that guides you through each of my key projects.</p>
                <p>Each project reveals the challenges, solutions, and technologies behind my work. And you can ask questions along the way to dive deeper into any aspect that interests you.</p>
              </div>
              ...
              <div className="space-y-2 mb-8 text-sm">
                ...
                {PROJECTS.map((project, index) => (
                  <div key={index} className="flex items-center text-brandGray-300 hover:text-brandGreen-400 transition-colors duration-200">
                    <span className="text-neonOrange-500 font-semibold mr-2">Project {index + 1}:</span>
