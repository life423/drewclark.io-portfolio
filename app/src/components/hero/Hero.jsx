    ...
    return (
        ...
        >
            ...
            <div className='absolute inset-0 z-0'>
                ...
                <div
                    className='absolute inset-0 bg-gradient-to-t 
                         from-brandGray-900/60 via-brandGreen-800/20 to-transparent'
                ></div>
            ...
            <div className='container mx-auto z-10 relative'>
                ...
                >
                    <p
                        className='max-w-2xl text-lg text-white/90 leading-relaxed
                        bg-brandGray-900/30 px-3 py-2 rounded-lg
