  ...
  return (
    <nav
      className={`
        fixed top-0 w-full h-16 px-4 flex items-center justify-between z-50
        transition-colors duration-300
        ${isScrolled ? 'bg-brandGray-800/70 backdrop-blur-md' : 'bg-transparent'}
      `}
    >
      {/* Logo/Brand */}
      <div className="text-xl font-bold text-white">MyBrand</div>
      ...
      {/* Infinity Drawer (mobile off-canvas) */}
      <InfinityDrawer isOpen={menuOpen} onClose={() => setMenuOpen(false)}>
